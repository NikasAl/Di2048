...
public class CustomTextButton extends Button {
	private final CustomShaderLabel label;
	...
	public CustomTextButton(String text, Skin skin, String styleName) {
	...
	public CustomTextButton(String text, TextButtonStyle style) {
		...
		setStyle(style);
		this.style = style;
		label = new CustomShaderLabel(text, new LabelStyle(style.font, style.fontColor));
//		label.setShader(Di2048Game.fontShader);
	...
	/** The style for a text button, see {@link CustomTextButton}.
	 * @author Nathan Sweet */
